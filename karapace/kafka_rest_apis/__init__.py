        ...
        while True:
            try:
                ...
                p = AIOKafkaProducer(
                    ...
                    sasl_plain_username=None if not self.config["sasl_plain_username"] else self.config["sasl_plain_username"],
                    sasl_plain_password=None if not self.config["sasl_plain_password"] else self.config["sasl_plain_password"],
